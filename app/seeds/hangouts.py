...
def seed_hangouts():
	...
	CodeAlong = Hangout(
		host=1, title="I'm creating an App", link="https://discord.gg/jJvff5Y6Ef", image="https://lh3.googleusercontent.com/proxy/5-TQQM50NftEWlVH5HE0shfQoEheYKSFr1o_1eaO2S-jPzcaPrWqldLe8HY0sRrTzGkzMo3v9GQ-hFmFpdTkDRxDK4Vqxp6mEGiWjWHwLGZglAW_LnO5fW53FX2KHB9VUqRPUQ23SUXU9Q0CCQHawW1YKz8fAfdfZztTrIDkourI", description="Coding an application for my Capstone Project! Come join in and help me or code along!", open=True, category="Workshop", startDate=date(2021, 12, 27), endDate=date(2021, 12, 30), startTime=time(9,00), endTime=time(17,00)
	)
	FutureEvent = Hangout(
