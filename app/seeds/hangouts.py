...
def seed_hangouts():
	...
	ListentoThis = Hangout(
		host=3, title="Check out this Music!", link="https://discord.gg/jJvff5Y6Ef", image="https://www.lifewire.com/thmb/xFwPYBWbaOoQFqTSWNeY30tWvdQ=/650x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-186591584-c4183cefc9684f72a9613e5f39e96bf6.jpg", description="I got music you should check out! Come listen along with me!", category="Concert", startDate=date(2024, 1, 5), endDate=date(2024, 1, 12), startTime=time(00,00), endTime=time(00,00)
	)
	CodeAlong = Hangout(
		host=1, title="I'm creating an App", link="https://discord.gg/jJvff5Y6Ef", image="https://thumbor.forbes.com/thumbor/960x0/https%3A%2F%2Fblogs-images.forbes.com%2Fforbestechcouncil%2Ffiles%2F2019%2F01%2Fcanva-photo-editor-8-7.jpg", description="Coding an application for my Capstone Project! Come join in and help me or code along!", category="Workshop", startDate=date(2021, 12, 27), endDate=date(2021, 12, 30), startTime=time(9,00), endTime=time(17,00)
	)
	FutureEvent = Hangout(
		host=1, title="The Future Discussion", link="https://discord.gg/jJvff5Y6Ef", image="https://images.immediate.co.uk/production/volatile/sites/4/2018/08/22-ideas-606ea9b.jpg?webp=true&quality=90&crop=8px%2C0px%2C1183px%2C509px&resize=940%2C399", description="A talk in the future, about the future! Come discuss potential upcoming technologies and breakthroughs and what they cna mean for the world in the coming years.", category="AMA", startDate=date(2022, 4, 1), endDate=date(2022, 4, 2), startTime=time(12,00), endTime=time(00,00)
	)
